...
class VinilTest(Produto):
    ...
    def setManta(self, manta):
        self.manta = manta
        self.manta.setMantaPreco()          #apenas para inputar o preco de 7.5
    
    def setPerfil(self, perfil):
        self.perfil = perfil
        self.perfil.setPerfilPreco()        #apenas para inputar o preco de 15

        #Outra possibilidade, trazendo db e filtrando preco nao precisaria do objeto MANTA
        self.manta = config['perfil'][perfil]
    ...
    def getVinilCalculado(self):
        preco_base_vinil = super().getPreco()
        return self.dimensoes.m2total() * preco_base_vinil
